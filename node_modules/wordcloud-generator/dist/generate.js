 ...
 */
export async function generate(words, normalize = true, savePath = 'wordcloud.png', opts = {}) {
    ...
    const generateWordCloudHTML = (words, backgroundColor, font, padding, viewportWidth, viewportHeight) => {
        return `
                <!DOCTYPE html>
                <html lang="en">
                <head>
